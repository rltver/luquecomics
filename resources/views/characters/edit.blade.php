<x-layouts.app2>
    ...
    <div>
        <div class="max-w-md mx-12 sm:mx-auto p-6 bg-white rounded-sm shadow">
            <h2 class="text-xl font-semibold mb-4">Actualizar imagen del personaje</h2>
            ...
            <form action="{{route('characters.updateImage',$character->id)}}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700">Nueva portada</label>
                    <div class="mt-2">
                        <div class="relative">
                            <input
                                type="file"
    ...
    <div class="w-full flex justify-center lg:px-10 max-w-[1200px] m-auto">
        <a href="{{route('characters.show',$character->id)}}" class="mt-6 w-3/4 min-w-70 lg:w-full bg-indigo-600 rounded-sm text-center text-white font-bold py-2">Volver</a>
    </div>
