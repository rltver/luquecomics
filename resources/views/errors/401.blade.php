<x-layouts.app2>
    <div class="text-center my-20">
        <h1 class="text-7xl font-bold text-yellow-500 mb-4">401</h1>
        <h2 class="text-2xl font-semibold mb-2">Unauthorized</h2>
        <h2 class="text-2xl font-semibold mb-2">Acceso no autorizado</h2>
        <p class="mb-6">Usuario no autenticado (no has iniciado sesion).</p>
        <a href="{{ route('home') }}"
