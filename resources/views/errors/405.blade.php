<x-layouts.app2>
    <div class="text-center my-20">
        <h1 class="text-7xl font-bold text-yellow-500 mb-4">405</h1>
        <h2 class="text-2xl font-semibold mb-2">Method Not Allowed</h2>
        <h2 class="text-2xl font-semibold mb-2">Método no aceptado</h2>
        <p class="mb-6">No se puede acceder a esta pagina por este metodo.</p>
        <a href="{{ route('home') }}"
